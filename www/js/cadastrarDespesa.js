...
function listarDespesas(){
  ...
  var lista = '<table class="table table-striped">';
      lista = lista + '<thead>';
      lista = lista + '<tr>';
      lista = lista + '<th scope="col">Categoria da despesa</th>';
      lista = lista + '<th scope="col">Data da despesa</th>';
      lista = lista + '<th scope="col">Nome da despesa</th>';
      lista = lista + '<th scope="col">Valor da despesa</th>';
